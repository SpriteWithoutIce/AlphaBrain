...
from benchmarks.SimplerEnv.eval.adaptive_ensemble import AdaptiveEnsembler
...
from AlphaBrain.model.tools import read_mode_config
...
class ModelClient:
    ...
    def get_action_chunk_size(policy_ckpt_path):
        ...
        try:
            ...
            return 16  # NeuralVLA default: future_action_window_size=15, +1=16
